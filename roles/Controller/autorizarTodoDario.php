			...
			for ($i = 0; $i < count($porAutorizar); $i++) {
				...
				if($result = mysqli_query($conexion, $sql)){
					...
					if($row[0] == "naranja"){
						...
						$sql2 = "UPDATE fomope SET color_estado = 'azul', usuario_name = '$userSeguir', fechaAutorizacion = '$fechaH[0] - $userSeguir' WHERE id_movimiento = '$porAutorizar[$i]'";
						...
						$sql2 = "UPDATE fomope SET color_estado = 'rosa', usuario_name = '$userSeguir' WHERE id_movimiento = '$porAutorizar[$i]'";
						...
						echo '<script type="text/javascript">alert("error '. mysqli_error($conexion).'");</script>';
		              		...
		              		echo "<script> alert('Autorizacion Correcta'); window.location.href = '../dario.php?usuario_rol=$userSeguir'</script>";
